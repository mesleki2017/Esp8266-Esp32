...
void webSocketEvent(byte num, WStype_t type, uint8_t * payload, size_t length)
{
    ...
    Serial.println("3------------------");
    if (length > 0){String _payload = String((char *) &payload[0]);Serial.println(_payload);tft.setCursor(20, 200);tft.print("            ");tft.setCursor(20, 200);tft.print(_payload);}
    else{Serial.println("data yok");}
