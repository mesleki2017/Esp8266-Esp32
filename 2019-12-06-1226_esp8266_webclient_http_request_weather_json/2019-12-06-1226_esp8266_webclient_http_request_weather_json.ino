...
tft.setTextColor(sari1, renk); tft.setTextSize(3);//yenibilgi https://forum.arduino.cc/index.php?topic=364055.0
...
tft.setTextColor(renk, ILI9341_WHITE);tft.setTextSize(5);
tft.setCursor(10,80);tft.print(" ");tft.print(b);tft.print(" C");tft.print(char(167));;tft.print(" ");
