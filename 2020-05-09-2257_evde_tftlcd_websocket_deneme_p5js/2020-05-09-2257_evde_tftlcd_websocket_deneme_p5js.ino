...
///////////////////////////////////////////
  ...
  if(file7){
    Serial.println("p5.min.js acildi");
     ...
     File file8 = SPIFFS.open("/p5.sound.js", "r");///deneme
  if(file8){
    Serial.println("p5.sound.js acildi");
  }
       File file9 = SPIFFS.open("/doorbell.mp3", "r");///deneme
  if(file9){
    Serial.println("doorbell.mp3 acildi");
  }
         File file10 = SPIFFS.open("/doorbell.ogg", "r");///deneme
  if(file10){
    Serial.println("doorbell.ogg acildi");
  }
...
server.serveStatic("/p5.sound.js", SPIFFS, "/p5.sound.js");
server.serveStatic("/doorbell.mp3", SPIFFS, "/doorbell.mp3");
server.serveStatic("/doorbell.ogg", SPIFFS, "/doorbell.ogg");
server.begin();
  delay(2000);
