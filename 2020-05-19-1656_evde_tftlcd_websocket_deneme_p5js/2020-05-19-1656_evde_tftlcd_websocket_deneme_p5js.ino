...
void webSocketEvent(byte num, WStype_t type, uint8_t * payload, size_t length)
{
   ...
   // Serial.print("WS payload length = ");Serial.println(length);
    if (length > 0){String _payload = String((char *) &payload[0]);tft.setCursor(20, 200);tft.print("            ");tft.setCursor(20, 200);tft.print(_payload);}
    else{
      tft.setCursor(20, 200);tft.print("            ");tft.setCursor(20, 200);tft.print("datayok");}
