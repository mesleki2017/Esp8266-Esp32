...
void zamandongu()
{
  ...
  if ( (t2 - t1)>= 1 ) {
    ...
    if ( (a2*100-a1*100)>=100 || (a2*100-a1*100)<=-100 || n==0 ){Serial.println("yeni sicaklik eklenecek");dataekle1();a1=a2;n=n+1; }// sicaklik degisimi 1 dereceden fazla is json a data ekle
